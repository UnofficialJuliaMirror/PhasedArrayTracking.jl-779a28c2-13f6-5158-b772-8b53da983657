...
"""
function init_tracking(::Val{N}, system, inits, sample_freq, interm_freq, sat_prn; pll_bandwidth = 18Hz, dll_bandwidth = 1Hz, min_integration_time = 0.5ms, max_integration_time = 1ms, carrier_loop_func = Tracking.init_3rd_order_bilinear_loop_filter, code_loop_func = Tracking.init_2nd_order_bilinear_loop_filter) where N
    ...
    Tracking.req_signal_and_track(correlator_outputs, last_valid_correlator_outputs, system, sample_freq, interm_freq, inits, dopplers, phases, code_shift, carrier_loop, code_loop, sat_prn, min_integration_time, max_integration_time, 0, data_bits)
end
